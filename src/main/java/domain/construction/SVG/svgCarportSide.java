...
public class svgCarportSide {
    ...
    public String Build(int lenght, int width, int ShedWidth, int ShedLength, double gableHeight) {
        ...
        int xShed = 600 - ShedWidth;
        int xStolpeStart = 60;
        int xStolpe = xStolpeStart + 180;

        //billede størrelse
        SvgCarportText.append("<svg width=\"1000\" height=\"1000\">");

        //skur
        SvgCarportText.append("<rect x=\""+xShed+"\" y=\"155\" rx=\"0\" ry=\"0\" width=\""+ShedWidth+"\" height=\"230\" style=\"fill:blue;stroke:black;stroke-width:3;opacity:1\" />");
        ...
        //Stolpe
                ...
                SvgCarportText.append("<rect x=\"240\" y=\"155\" rx=\"0\" ry=\"0\" width=\"15\" height=\"230\" style=\"fill:white;stroke:black;stroke-width:3;opacity:1\" />");
                SvgCarportText.append("<rect x=\"420\" y=\"155\" rx=\"0\" ry=\"0\" width=\"15\" height=\"230\" style=\"fill:white;stroke:black;stroke-width:3;opacity:1\" />");
                SvgCarportText.append("<rect x=\"600\" y=\"155\" rx=\"0\" ry=\"0\" width=\"15\" height=\"230\" style=\"fill:white;stroke:black;stroke-width:3;opacity:1\" />");

        //tag
                SvgCarportText.append("<rect x=\"10\" y=\"60\" rx=\"0\" ry=\"0\" width=\"630\" height=\"80\" style=\"fill:grey;stroke:black;stroke-width:3;opacity:1\" />");
        //Rem
                SvgCarportText.append("<rect x=\"10\" y=\"140\" rx=\"0\" ry=\"0\" width=\"630\" height=\"15\" style=\"fill:white;stroke:black;stroke-width:3;opacity:1\" />");

        //Målestokke
                SvgCarportText.append("<text x=\"280\" y=\"440\" fill=\"red\" transform=\"rotate(0 20,40)\">total længde 7m</text>");
                SvgCarportText.append("<line x1=\"10\" y1=\"400\" x2=\"640\" y2=\"400\" style=\"stroke:rgb(0,0,0);stroke-width:1\" />");
